...
?>
	...
	<script language="javascript" type="text/javascript">
		...
		acd2 = new Date();
		acd2ok=acd2.getTime();
		window.location = '?action=phptanzhen&speed=' +(acd2ok-acd1ok)+'#w_networkspeed';
	</script>
<?php
}
//网速测试-结束
...
th{padding: 3px 6px; font-weight:bold;background:#E3FFC8;color:#626262;border:1px solid #cccccc; text-align:left;}
...
.w_foot{height:25px;text-align:center; background:#E3FFC8;}
...
<table>
  ...
  <tr align="center">
    ...
    <td align="left"><a href="http://www.pinluo.com" target="_blank">品络互联 Pinluo.com</a></td>
...
<table>
  ...
  ?>
	...
	<table>
		<tr>
			<td class="w_foot"><A HREF="http://www.pinluo.com" target="_blank"><?php echo $title.$version;?></A></td>
