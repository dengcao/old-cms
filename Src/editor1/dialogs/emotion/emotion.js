window.onload = function () {
    ...
    emotion.SmileyPath=editor.options.UEDITOR_HOME_URL.replace("/editor1/","/") + "5300/emotion/";//定义表情目录
...
function InsertSmiley( url, evt ) {
    var obj = {
		src:editor.options.emotionLocalization ? url : url
        //src:editor.options.emotionLocalization ? editor.options.UEDITOR_HOME_URL + "5300/emotion/" + url : url
    };
        ...
        for ( var j = 0; j < imgColNum; j++, i++ ) {
            ...
            if ( faceImage ) {
                ...
                //textHTML.push( '<img  style="background-position:left ' + offset + 'px;" title="' + infor + '" src="' + emotion.SmileyPath + (editor.options.emotionLocalization ? '0.gif" width="' : 'default/0.gif" width="') + iWidth + '" height="' + iHeight + '"></img>' );
				   if (emotion.imageFolders[tabName]=="qq/"){
				    textHTML.push( '<img  style="background-position:' + offset + 'px top;" title="' + infor + '" src="' + emotion.SmileyPath + (editor.options.emotionLocalization ? '0.gif" width="' : 'default/0.gif" width="') + iWidth + '" height="' + iHeight + '"></img>' );
				    }else{
				    textHTML.push( '<img  style="background-position:left ' + offset + 'px;" title="' + infor + '" src="' + emotion.SmileyPath + (editor.options.emotionLocalization ? '0.gif" width="' : 'default/0.gif" width="') + iWidth + '" height="' + iHeight + '"></img>' );
					}
                textHTML.push( '</span>' );
