...
K.options = {
	...
	fontSizeTable : ['9px', '10px', '11px', '12px', '14px', '16px', '18px', '20px', '24px', '26px', '28px', '30px', '32px', '36px', '40px'],
	htmlTags : {
...
_plugin('core', function(K) {
	...
	self.clickToolbar('about', function() {
		var html = '<div style="margin:20px;">' +
			'<div>多功能编辑器 4.1.2</div>' +
			'<div><p>如在使用过程中遇到任何问题，欢迎反馈：<br>E-mail：<a href="mailto:dzh188@qq.com">dzh188@qq.com</a><br>我的码云：<a href="https://gitee.com/caozha" target="_blank">https://gitee.com/caozha</a></p></div>' +
			'</div>';
		self.createDialog({
			name : 'about',
			width : 300,
