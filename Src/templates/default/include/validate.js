...
{
	//判断输入的内容
	if ( IsBlank( FormName.FB_Type,"咨询类型" ) )
		return false;
	if ( IsBlank( FormName.FB_LinkMan,"联系人" ) )
		return false;
	if ( IsBlank( FormName.FB_Email,"电子邮件" ) )
		return false;
	if ( CheckEmail( FormName.FB_Email,false ) ) 
		return false;
	if ( IsBlank( FormName.FB_Subject,"咨询主题" ) )
		return false;
	if ( IsBlank( FormName.FB_Content,"咨询内容" ) )
		return false;
	if ( IsBlank( FormName.FB_Date,"咨询日期" ) )
		return false; 
	FormName.submit();
}
//////////////////////////////////////////////////////////////////////////////////////////
